"""Preprocess HuggingFaceH4/MATH-500 to verl parquet format (standalone)."""
import argparse
import json
import os
...
def main():
    ...
    out = os.path.join(args.local_save_dir, "math500.parquet")
    ds.to_parquet(out)
    with open(os.path.join(args.local_save_dir, "math500_example.json"), "w") as f:
