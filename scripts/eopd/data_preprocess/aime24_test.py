"""Preprocess Maxwell-Jia/AIME_2024 to verl parquet format (standalone)."""
import argparse
import json
import os
...
def main():
    ...
    out = os.path.join(args.local_save_dir, "aime24.parquet")
    ds.to_parquet(out)
    with open(os.path.join(args.local_save_dir, "aime24_example.json"), "w") as f:
